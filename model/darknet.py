...
darknet_conv_parameter = {'kernel_regularizer': tf.keras.regularizers.l2(5e-4),
                          'use_bias': False,
                          'padding': }
               filters,
               kernel_size,
...
def DarknetConv2D_BN_Leaky(filter, kernel_size, strides=(1, 1), **kwargs):
...
@wraps(tf.python.keras.layers.Conv2D)
